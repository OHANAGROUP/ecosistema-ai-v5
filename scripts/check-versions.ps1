...
if ($hits) { 
    Write-Error "⛔ Versiones contaminadas detectadas anidadas en el codigo base:"
    $hits | Format-Table -AutoSize
    exit 1 
} else { 
    Write-Host "✅ Versiones limpias. Sistema listo para despliegue." -ForegroundColor Green
}
