 ...
 *  ðŸŸ¢ Days 14-8  â†’ Normal (sidebar badge)
 *  ðŸŸ¡ Days 7-4   â†’ Warning (daily toast)
 *  ðŸ”´ Days 3-1   â†’ Urgency (modal on open)
 *  â›” Day 0      â†’ Hard block (full overlay)
 *
 * Usage: TrialGuard.check()  â€” call after unlockApp()
 */
...
const TrialGuard = (() => {
    ...
    // â”€â”€â”€ State Logic â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€â”€ Sidebar Badge â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    function _showToast(daysLeft, state) {
        ...
        const msg = isRed
            ? `âš ï¸ Â¡Solo te quedan <strong>${daysLeft} dÃ­a${daysLeft !== 1 ? 's' : ''}</strong> de prueba! Contrata ahora y no pierdas tus datos.`
            : `â° Tu prueba gratuita vence en <strong>${daysLeft} dÃ­as</strong>. Â¡Aprovecha antes de que termine!`;
        ...
        toast.innerHTML = `
            <div style="display:flex;align-items:flex-start;gap:10px;">
                ...
                <button onclick="this.closest('#trial-toast').remove()" style="background:none;border:none;color:rgba(255,255,255,0.5);cursor:pointer;font-size:18px;line-height:1;padding:0;margin-top:-2px">Ã—</button>
            </div>
    ...
    // â”€â”€â”€ Urgency Modal (Days 3â€“1) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    function _showUrgencyModal(daysLeft) {
        ...
        overlay.innerHTML = `
            ...
            ">
                <div style="font-size:52px;margin-bottom:16px">âš ï¸</div>
                <div style="background:rgba(239,68,68,0.15);border:1px solid rgba(239,68,68,0.3);border-radius:100px;display:inline-block;padding:4px 16px;font-size:11px;font-weight:700;color:#f87171;text-transform:uppercase;letter-spacing:1px;margin-bottom:20px">
                    Prueba expira en ${daysLeft} dÃ­a${daysLeft !== 1 ? 's' : ''}
                </div>
                <h2 style="font-size:24px;font-weight:800;margin-bottom:10px">Â¡Tu prueba estÃ¡ por terminar!</h2>
                <p style="color:rgba(255,255,255,0.6);font-size:14px;line-height:1.6;margin-bottom:28px">
                    Tienes <strong style="color:#f87171">${daysLeft} dÃ­a${daysLeft !== 1 ? 's' : ''}</strong> antes de que se congele tu acceso.<br>
                ...
                <div style="background:rgba(255,255,255,0.04);border-radius:12px;padding:16px;margin-bottom:24px;text-align:left">
                    ...
                    <div style="font-size:13px;line-height:2;color:rgba(255,255,255,0.75)">
                        âœ… &nbsp;Agentes IA sin lÃ­mite de ciclos<br>
                        âœ… &nbsp;Backup automÃ¡tico en Supabase<br>
                        âœ… &nbsp;Multi-usuario y RLS por empresa<br>
    ...
    // â”€â”€â”€ Hard Block Overlay (Expired) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        block.innerHTML = `
            ...
            ">
                ...
                <p style="color:rgba(255,255,255,0.55);font-size:15px;line-height:1.6;margin-bottom:32px">
                    Tu prueba gratuita de 14 dÃ­as ha concluido.<br>
                ...
                <div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:20px;padding:24px;margin-bottom:28px">
                    <div style="font-size:13px;color:rgba(255,255,255,0.4);margin-bottom:16px;text-transform:uppercase;letter-spacing:1px">Plan Empresa â€” Desde</div>
                    ...
                    <div style="font-size:13px;color:rgba(255,255,255,0.5);margin-top:4px">+ IVA Â· Multi-usuario Â· Sin permanencia</div>
                    <hr style="border:none;border-top:1px solid rgba(255,255,255,0.08);margin:20px 0">
                    <div style="font-size:13px;line-height:2;color:rgba(255,255,255,0.7);text-align:left">
                        âœ… &nbsp;Agentes IA Nivel 5 Â· Ciclos ilimitados<br>
                        âœ… &nbsp;Supabase real-time Â· RLS multi-tenant<br>
                        âœ… &nbsp;Dashboard ejecutivo + reportes PDF<br>
                        âœ… &nbsp;Soporte prioritario 48h
                    </div>
                </div>
                ...
                <a href="upgrade.html" style="
                    ...
                    margin-bottom:16px;
                ">ðŸš€ Contratar Ahora</a>

                <p style="font-size:12px;color:rgba(255,255,255,0.25)">
                    Â¿Necesitas mÃ¡s tiempo? EscrÃ­benos a <span style="color:rgba(255,255,255,0.4)">ventas@alpaconstruccioneingenieria.cl</span>
                </p>
            </div>
        `;
    ...
    // â”€â”€â”€ CSS Animations (injected once) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
