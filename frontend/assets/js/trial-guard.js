...
const TrialGuard = (() => {
    ...
    function _showToast(daysLeft, state) {
        ...
        const msg = isRed
            ? `⚠️ ¡Solo te quedan <strong>${daysLeft} día${daysLeft !== 1 ? 's' : ''}</strong> de prueba! Contrata ahora y no pierdas tus datos.`
            : `⏰ Tu prueba gratuita vence en <strong>${daysLeft} días</strong>. ¡Aprovecha antes de que termine!`;
        ...
        overlay.innerHTML = `
            ...
            ">
                ...
                <div style="background:rgba(239,68,68,0.15);border:1px solid rgba(239,68,68,0.3);border-radius:100px;display:inline-block;padding:4px 16px;font-size:11px;font-weight:700;color:#f87171;text-transform:uppercase;letter-spacing:1px;margin-bottom:20px">
                    Prueba expira en ${daysLeft} día${daysLeft !== 1 ? 's' : ''}
                </div>
                <h2 style="font-size:24px;font-weight:800;margin-bottom:10px">¡Tu prueba está por terminar!</h2>
                <p style="color:rgba(255,255,255,0.6);font-size:14px;line-height:1.6;margin-bottom:28px">
                    Tienes <strong style="color:#f87171">${daysLeft} día${daysLeft !== 1 ? 's' : ''}</strong> antes de que se congele tu acceso.<br>
                ...
                <div style="background:rgba(255,255,255,0.04);border-radius:12px;padding:16px;margin-bottom:24px;text-align:left">
                    ...
                    <div style="font-size:13px;line-height:2;color:rgba(255,255,255,0.75)">
                        ✅ &nbsp;Agentes IA sin límite de ciclos<br>
                        ✅ &nbsp;Backup automático en Supabase<br>
        ...
        block.innerHTML = `
            ...
            ">
                ...
                <p style="color:rgba(255,255,255,0.55);font-size:15px;line-height:1.6;margin-bottom:32px">
                    Tu prueba gratuita de 14 días ha concluido.<br>
                ...
                <p style="font-size:12px;color:rgba(255,255,255,0.25)">
                    ¿Necesitas más tiempo? Escríbenos a <span style="color:rgba(255,255,255,0.4)">ventas@alpaconstruccioneingenieria.cl</span>
                </p>
            </div>
        `;
